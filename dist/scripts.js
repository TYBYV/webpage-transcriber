...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsShallowCompare = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsSelect = __webpack_require__(91);
	...
	function select(rule) {
	  ...
	  var elements = _utilsSelect2['default'].call(root, rule.selector);
	  return elements.map(function (el) {
	    return _extends({}, rule, { el: el });
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flatten = __webpack_require__(178);
	...
	function flatMap(fn) {
	  ...
	  return (_context = this.map(fn), _flatten2['default']).call(_context);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsComponent = __webpack_require__(6);
	
	var _viewsComponent2 = _interopRequireDefault(_viewsComponent);
	...
	var Form = (function (_Component) {
	    ...
	    _createClass(Form, [{
	        ...
	        key: 'renderControl',
	        value: function renderControl(control, i) {
	            switch (control.tagName) {
	                case 'INPUT':
	                    return this.renderInput(control, i);
	            }
	        }
	    }, {
	        key: 'renderInput',
	        value: function renderInput(input, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fastclick = __webpack_require__(93);
	...
	var _viewsRoot = __webpack_require__(181);
	
	var _viewsRoot2 = _interopRequireDefault(_viewsRoot);
	
	var _utilsIsMobile = __webpack_require__(179);
	
	var _utilsIsMobile2 = _interopRequireDefault(_utilsIsMobile);
	
	var _scraper = __webpack_require__(169);
	
	var _scraper2 = _interopRequireDefault(_scraper);
	
	var _spec = __webpack_require__(177);
	...
	function bootstrap() {
	    ...
	    var payload = (0, _scraper2['default'])(_spec2['default']);
	    ...
	    _reactDom2['default'].render(_react2['default'].createElement(_viewsRoot2['default'], { payload: payload }), rootNode);
	}
	...
	*/
	if ((0, _utilsIsMobile2['default'])()) bootstrap();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrape = __webpack_require__(170);
	
	var _scrape2 = _interopRequireDefault(_scrape);

	exports['default'] = _scrape2['default'];
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsFlatMap = __webpack_require__(90);
	
	var _utilsFlatMap2 = _interopRequireDefault(_utilsFlatMap);
	
	var _utilsRegroup = __webpack_require__(180);
	
	var _utilsRegroup2 = _interopRequireDefault(_utilsRegroup);
	...
	function scrape(spec) {
	    ...
	    var rules = (_context = spec.rules, _utilsFlatMap2['default']).call(_context, function (rule) {
	        return (0, _select2['default'])(rule, root);
	    });
	
	    // Run the transform over each rule, returning a data
	    // representation that is suitable for the template.
	    var roles = rules.map(function (rule) {
	        return _extends({ role: rule.role }, (0, _transform2['default'])(rule));
	    });
	    payload.roles = _utilsRegroup2['default'].call(roles, function (x) {
	        return x.role;
	    });
...
/***/ function(module, exports) {
	...
	exports['default'] = contentTransform;
	
	function contentTransform(rule) {
	    return {
	        type: 'content',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function formTransform(rule) {
	    ...
	    var controls = (_context = rule.controls, _utilsFlatMap2['default']).call(_context, function (control) {
	        return (0, _select2['default'])(control, el).map(_2['default']);
	    });
	    return { type: 'form', label: label, method: method, action: action, controls: controls };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function listTransform(rule) {
	  var el = rule.el;
	  var label = rule.label;
	
	  var header = (0, _select2['default'])(rule.header, el).map(_2['default']);
	  var items = (0, _select2['default'])(rule.items, el).map(_2['default']);
	  return { type: 'list', label: label, header: header, items: items };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function navTransform(rule) {
	    var el = rule.el;
	    var label = rule.label;
	
	    var items = _utilsSelect2['default'].call(el, rule.itemSelector).map(function (item) {
	        return {
	            href: item.href,
	            text: item.innerText
	        };
	    });
	    return { type: 'nav', label: label, items: items };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function transform(rule, el) {
	  var transform = transforms[rule.transform];
	...
	*/
	...
	exports['default'] = {
	    ...
	    rules: [{
	        ...
	        controls: [{ name: 'q', transform: 'input', selector: 'input[name="q"]' }, { name: 'near', transform: 'input', selector: 'input[name="near"]' }, { name: 'submit', transform: 'input', selector: 'button' }]
	    }, {
	        role: 'filters',
	        label: 'Location',
	        transform: 'form',
	        selector: '#left_nav > form',
	        controls: [{ name: 'near', transform: 'input', selector: 'input[name="near"]' }, { name: 'stok', transform: 'input', selector: 'input[name="stok"]' }, { name: 'rl', transform: 'input', selector: 'input[name="rl"]' }, { name: 'submit', transform: 'input', selector: 'input[type="submit"]' }]
	    }, {
	        role: 'filters',
	        label: 'Dates',
	        transform: 'nav',
...
/***/ function(module, exports) {
	...
	var matcher = /(iphone|android|windows phone)/i;
...
/***/ function(module, exports) {
	...
	exports["default"] = regroup;
	
	function regroup(selector) {
	    var obj = {};
	...
	var Root = (function (_Component) {
	    ...
	    function Root() {
	        ...
	        this.switchTemplate = function () {
	            var template = _this.state.template === 'google' ? 'folio' : 'google';
	...
	var List = (function (_Component) {
	    ...
	    _createClass(List, [{
	        ...
	        value: function renderHeader() {
	            var style = _extends({}, List.styles.header, this.state.collapsed ? List.styles.headerCollapsed : {});
	            return _react2['default'].createElement(
	                'div',
	                { style: style,
	                    onClick: this.toggle },
	                _react2['default'].createElement('div', { dangerouslySetInnerHTML: { __html: this.props.header[0].html } })
	            );
	        }
	    }, {
	        key: 'renderList',
	        value: function renderList() {
	            var style = _extends({}, List.styles.list, this.state.collapsed ? List.styles.listCollapsed : {});
	            return _react2['default'].createElement(
	                'ul',
	                { style: style },
	        ...
	        value: function renderItem(item, i) {
	            return _react2['default'].createElement(
	                'li',
	                { key: i, style: List.styles.item },
	                _react2['default'].createElement('div', { dangerouslySetInnerHTML: { __html: item.html } })
	            );
	        }
	    }], [{
	        key: 'propTypes',
	...
	var Pagination = (function (_Component) {
	    ...
	    _createClass(Pagination, [{
	        ...
	        value: function renderItem(item, i) {
	            return _react2['default'].createElement(
	                'li',
	                { key: i, style: Pagination.styles.item },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Form2 = __webpack_require__(183);
	
	var _Form3 = _interopRequireDefault(_Form2);
	
	var SearchForm = (function (_Form) {
	    ...
	    _createClass(SearchForm, [{
	        ...
	        value: function renderControl(control, i) {
	            switch (control.name) {
	                case 'q':
	                    return this.renderQ(control, i);
	                case 'submit':
	                    return this.renderSubmit(control, i);
	                default:
	                    return _get(Object.getPrototypeOf(SearchForm.prototype), 'renderControl', this).call(this, control, i);
	            }
	        }
	    }, {
	        key: 'renderQ',
	        value: function renderQ(control, i) {
	            return _react2['default'].createElement('input', {
	                key: i,
	                name: control.name,
	                type: control.type,
	        ...
	        key: 'renderSubmit',
	        value: function renderSubmit(control, i) {
	            return _react2['default'].createElement(
	                'button',
	                {
	                    key: i,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TitleBar = __webpack_require__(187);
	
	var _TitleBar2 = _interopRequireDefault(_TitleBar);
	
	var _SearchForm = __webpack_require__(186);
	...
	var FolioTemplate = (function (_Component) {
	    _inherits(FolioTemplate, _Component);
	
	    function FolioTemplate() {
	        _classCallCheck(this, FolioTemplate);
	
	        _get(Object.getPrototypeOf(FolioTemplate.prototype), 'constructor', this).apply(this, arguments);
	    }
	
	    _createClass(FolioTemplate, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { style: FolioTemplate.styles.container },
	                _react2['default'].createElement(_TitleBar2['default'], { text: 'Google Movie Search',
	                    onClickMenu: this.toggleSidebar }),
	                roles.search ? _react2['default'].createElement(_SearchForm2['default'], roles.search[0]) : null,
	                _react2['default'].createElement(
	                    _Content2['default'],
	                    { subject: roles.subject[0].text },
	                    roles.content ? roles.content.map(function (x, i) {
	                        return _react2['default'].createElement(_List2['default'], _extends({ key: i }, x));
	                    }) : null,
	                    roles.pagination ? _react2['default'].createElement(_Pagination2['default'], roles.pagination[0]) : null
	                ),
	                _react2['default'].createElement(
	                    'button',
	                    { style: FolioTemplate.styles.templateSwitcher,
	        ...
	        value: {
	            payload: _react.PropTypes.object.isRequired,
	            onSwitchTemplate: _react.PropTypes.func
	        },
	        enumerable: true
	    }, {
	        key: 'styles',
	    ...
	    _createClass(Filter, [{
	        ...
	        value: function renderFilter() {
	            switch (this.props.type) {
	                case 'nav':
	                    return _react2['default'].createElement(_Nav2['default'], this.props);
	                case 'form':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuButton = (function (_Component) {
	    ...
	    function MenuButton() {
	        ...
	        _get(Object.getPrototypeOf(MenuButton.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(MenuButton, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'button',
	                { style: MenuButton.styles.button,
	    ...
	    _createClass(Nav, [{
	        ...
	        value: function renderItem(item, i) {
	            return _react2['default'].createElement(
	                ...
	                item.href ? _react2['default'].createElement(
	                    'a',
	                    { style: Nav.styles.item, href: item.href },
	                    item.text
	                ) : _react2['default'].createElement(
	                    'span',
	                    { style: Nav.styles.item },
	                    item.text
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sidebar = (function (_Component) {
	    ...
	    _createClass(Sidebar, [{
	        key: 'render',
	        value: function render() {
	            var style = _extends({}, Sidebar.styles.sidebar, this.props.open ? Sidebar.styles.open : {});
	            var overlayStyle = _extends({}, Sidebar.styles.overlay, this.props.open ? Sidebar.styles.overlayOpen : {});
	            return _react2['default'].createElement(
	                'div',
	                { style: overlayStyle,
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'button',
	                        { style: Sidebar.styles.templateSwitcher,
	                            onClick: this.props.onSwitchTemplate },
	                        'Switch template'
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuButton = __webpack_require__(193);
	    ...
	    _createClass(Title, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { style: Title.styles.container },
	                _react2['default'].createElement(_MenuButton2['default'], { onClick: this.props.onClickMenu }),
	                _react2['default'].createElement(
	                    'h1',
	                    { style: Title.styles.title },
	                    this.props.text
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sidebar = __webpack_require__(197);
	...
	var _Pagination = __webpack_require__(195);
	
	var _Pagination2 = _interopRequireDefault(_Pagination);
	
	var _TitleBar = __webpack_require__(198);
	
	var _TitleBar2 = _interopRequireDefault(_TitleBar);
	
	var _SearchForm = __webpack_require__(196);
	...
	var GoogleTemplate = (function (_Component) {
	    _inherits(GoogleTemplate, _Component);
	
	    function GoogleTemplate() {
	        var _this = this;
	
	        _classCallCheck(this, GoogleTemplate);
	
	        _get(Object.getPrototypeOf(GoogleTemplate.prototype), 'constructor', this).apply(this, arguments);
	        ...
	        this.toggleSidebar = function () {
	            _this.setState({ sidebarOpen: !_this.state.sidebarOpen });
	        };
	    }
	
	    _createClass(GoogleTemplate, [{
	        key: 'render',
	        value: function render() {
	            var payload = this.props.payload;
	            var roles = payload.roles;
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { style: GoogleTemplate.styles.container },
	                _react2['default'].createElement(
	                    _Sidebar2['default'],
	                    { open: this.state.sidebarOpen,
	                        onClose: this.toggleSidebar,
	                        onSwitchTemplate: this.props.onSwitchTemplate },
	                    roles.filters ? roles.filters.map(function (x, i) {
	                        return _react2['default'].createElement(_Filter2['default'], _extends({ key: i }, x));
	                    }) : null
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { style: GoogleTemplate.styles.content },
	                    _react2['default'].createElement(
	                        _Header2['default'],
	                        null,
	                        _react2['default'].createElement(_TitleBar2['default'], { text: 'Google Movie Search',
	...
	exports['default'] = GoogleTemplate;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Template = (function (_Component) {
	    ...
	    _createClass(Template, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var template = templates[this.props.template];
	            return _react2['default'].createFactory(template)(this.props);
	        }
	    }], [{
	        key: 'propTypes',
	        value: {
